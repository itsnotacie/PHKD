...
class LocalizationNet(nn.Module):
    ...
    def forward(self, sat_feat_list, pano_feat_list, meter_per_pixel):
        ...
        return sat_feat_dict, sat_conf_dict, g2s_feat_dict, g2s_conf_dict, pano_conf_dict, pano_feat_dict
